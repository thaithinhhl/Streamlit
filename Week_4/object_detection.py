...
MODEL = 'E:\\source (1)\\source\\model\\MobileNetSSD_deploy.caffemodel'
PROTOTXT = 'E:\\source (1)\\source\\model\\MobileNetSSD_deploy.prototxt.txt'


def process_image(image):
    blob = cv2.dnn.blobFromImage(
        cv2.resize(image, (300, 300)), 0.007843, (300, 300), 125.7
    )
